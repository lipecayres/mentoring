...
const boardPassengers = function (n, wait) {
  ...
  setTimeout(function () {
    console.log(`We are now boarding all ${n} passenges`);
...
*/
/* the setTimeout function has access to the scope variables even after the execution has been ended because of closures */

// const perGroup = 1000;

/* closures has priorities over the scope chain */
